  ...
  main.innerHTML = `
    <section class="hero">
      <div><p class="eyebrow">Tony C · The listening room</p><h1>Same voice.<br><em>Wildly different</em><br>directions.</h1>
        ...
        <div class="actions"><button class="primary" id="play-all">Play the collection <span aria-hidden="true">↗</span></button><a class="text-link" href="/mixtapes/">Make a mixtape →</a><a class="text-link" href="/distonyc/">Make a request <span aria-hidden="true">→</span></a></div>
      </div>
