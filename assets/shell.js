...
// sheets, mixtapes, the queue, Backstage and the request form) change here by fetching the next page and
...
const routes = /^\/(?:$|mixtapes(?:\/|$)|queue(?:\/|$)|admin(?:\/|$)|distonyc(?:\/|$)|lyrics(?:\/|$)|original-prompt(?:\/|$))/;
