...
export async function publicQueue(main, { escape, date, badge, safeUrl }) {
  ...
  async function refresh() {
    ...
    try {
      ...
      revealRelease = false;
      await announceAttention(needsAttention);
