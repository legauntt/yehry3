...
// Paid generation once asked for a separate password and saved it here; it no longer does, so a saved one is dropped.
try { localStorage.removeItem("yehry3:paid-music-password"); } catch { /* Storage is optional. */ }
