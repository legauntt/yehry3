...
- Remixed releases carry a **Remix** badge. Each grid/list card has a play/pause toggle synchronized with the persistent bottom player. The hero record shows a comic-book caption with a real catalog lyric when clicked and occasionally while the page is idle.
