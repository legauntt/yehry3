...
- Newly generated songs include a **Lyrics** link in the main list, opening a shareable sheet with in-browser playback, line highlighting, automatic scrolling, click-to-seek, download, and print controls. Saved lyrics and bounded line cues travel with the song metadata in Mongo and the fallback catalog. All existing songs were backfilled from their retained production word timestamps; new songs derive cues locally without another model call or render.
