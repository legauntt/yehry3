...
- Remixed releases carry a **Remix** badge. Each grid/list card has a play/pause toggle synchronized with the persistent bottom player, and the hero record occasionally sings a real catalog lyric after the page has been idle.
