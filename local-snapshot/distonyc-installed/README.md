...
Current voice defaults, the September 17 repair rollout, model comparisons, and the capped paid trial are documented in [GENERATION-UPGRADES.md](GENERATION-UPGRADES.md).
