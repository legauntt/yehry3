...
def render(request):
    ...
    # Composition-repair controllers wrap every supported music backend. Their
    # child requests recurse into this function and then dispatch normally.
    # Keeping these hooks ahead of backend selection prevents a paid-backend
    # retry from rerunning the failed parent instead of its reserved child.
